...
olmo_7b_all_prefixes_bigrams = brm(log_odds ~ GenPref * log_bigram_odds_ratio + (GenPref | prompt_value) + ( 1 | Alpha),
                       ...
                       control = list(adapt_delta=0.99, max_treedepth = 15),
                       #control = list(max_treedepth = 20),
                       file = '../Data/olmo_7b_all_prefixes_bigrams'
                      )
...
olmo_2_1b_all_prefixes_bigrams = brm(log_odds ~ GenPref * log_bigram_odds_ratio + (GenPref | prompt_value) + ( 1 | Alpha),
                       ...
                       control = list(adapt_delta=0.99, max_treedepth = 15),
                       #control = list(max_treedepth = 20),
                       file = '../Data/olmo_2_1b_all_prefixes_bigrams'
                      )
...
olmo_2_32b_all_prefixes_bigrams = brm(log_odds ~ GenPref * log_bigram_odds_ratio + (GenPref | prompt_value) + ( 1 | Alpha),
                       ...
                       control = list(adapt_delta=0.99, max_treedepth = 15),
                       #control = list(max_treedepth = 20),
                       file = '../Data/olmo_2_32b_all_prefixes_bigrams'
                      )
...
```{r}
fixef_olmo2_1b = fixef(all_models_olmo2_1b)
fixef_olmo2_1b = fixef(all_models_olmo7b)
fixef_gpt2 = fixef(all_models_gpt2)
fixef_oss_120b = fixef(all_models_gptoss)
...
extract_p_gt0 = function(fit, model_name) {
...
df_fixef = bind_rows(
  extract_fixef(all_models_olmo2_1b, "OLMo-2-1B"),
  extract_fixef(all_models_olmo7b,   "OLMo-7B"),
  extract_fixef(all_models_gpt2,     "GPT-2"),
  extract_fixef(all_models_gptoss,   "GPT-OSS-120B")
) 

df_p_gt0 <- bind_rows(
  extract_p_gt0(all_models_olmo2_1b, "OLMo-2-1B"),
  extract_p_gt0(all_models_olmo7b,   "OLMo-7B"),
  extract_p_gt0(all_models_gpt2,     "GPT-2"),
  extract_p_gt0(all_models_gptoss,   "GPT-OSS-120B")
)

df_combined <- df_fixef |>
  left_join(df_p_gt0, by = c("term", "model")) %>%
  select(model, Estimate, Q2.5, Q97.5, p_gt0) %>%
  mutate(p_gt0 = p_gt0 * 100)
...
```{r}
df_fixef_bigrams <- bind_rows(
  extract_fixef(olmo_2_1b_all_prefixes_bigrams, "OLMo-2-1B"),
  extract_fixef(olmo_7b_all_prefixes_bigrams,   "OLMo-7B")
)

df_p_gt0_bigrams <- bind_rows(
  extract_p_gt0(olmo_2_1b_all_prefixes_bigrams, "OLMo-2-1B"),
  extract_p_gt0(olmo_7b_all_prefixes_bigrams,   "OLMo-7B")
)


df_combined_bigrams <- df_fixef_bigrams |>
  left_join(df_p_gt0_bigrams, by = c("term", "model")) |>
  select(model, term, Estimate, Q2.5, Q97.5, p_gt0) |>
  mutate(p_gt0 = p_gt0 * 100) |>
  mutate(
    Estimate = round(Estimate, 3),
    Q2.5     = round(Q2.5, 3),
...
```{r}
df_fixef_all_constraints <- bind_rows(
  extract_fixef(olmo2_1b_all_prefixes_all_constraints, "OLMo-2-1B"),
  extract_fixef(olmo7b_all_prefixes_all_constraints,   "OLMo-7B"),
  extract_fixef(gpt2_all_prefixes_all_constraints,     "GPT-2"),
  extract_fixef(gptoss_all_prefixes_all_constraints,   "GPT-OSS-120B")
)

df_p_gt0_all_constraints <- bind_rows(
  extract_p_gt0(olmo2_1b_all_prefixes_all_constraints, "OLMo-2-1B"),
  extract_p_gt0(olmo7b_all_prefixes_all_constraints,   "OLMo-7B"),
  extract_p_gt0(gpt2_all_prefixes_all_constraints,     "GPT-2"),
  extract_p_gt0(gptoss_all_prefixes_all_constraints,   "GPT-OSS-120B")
)

df_combined_all_constraints <- df_fixef_all_constraints |>
  left_join(df_p_gt0_all_constraints, by = c("term", "model")) |>
  select(model, term, Estimate, Q2.5, Q97.5, p_gt0) |>
  mutate(p_gt0 = p_gt0 * 100) |>
  mutate(
    Estimate = round(Estimate, 3),
