...
def main():
    ...
    if args.checkpoint:
        ...
        model_dir = f"{cache_dir}/models--{repo_name}/refs/{args.checkpoint}"
    else:
        path = f'../../Data/{file_name}.csv'
        binom_probs_df.to_csv(path)
        model_dir = f"{cache_dir}/models--{repo_name}/refs/main"
...
data_just_binoms['AandB'] = 'Possibly ' + data_just_binoms['Word1'] + ' and ' + data_just_binoms['Word2']
data_just_binoms['BandA'] = 'Possibly ' + data_just_binoms['Word2'] + ' and ' + data_just_binoms['Word1']
print(model_name)
